...
namespace SporticsWebAPI.Controllers
{
    ...
    {
        private readonly IHousesRepository _repository;
        ...
        [HttpPost]
        public async Task<ActionResult<Houses>> Post([FromBody] Houses obj)
        {
            try
            {
        ...
        [HttpPut]
        public async Task<ActionResult<Houses>> Put(int id, [FromBody] Houses obj)
        {
            try
            {
                if (id != obj.Id)
